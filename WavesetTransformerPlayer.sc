WavesetTransformerPlayer {
	...
	*new {| subBufNum, files  |
	...
	biterSub{arg multiplier = 8, waveSetAmount = 10;
		...
		this.waveset.harmLevel = {0.15};
		this.waveset.distance = {0.0};
		this.waveset.subAmount = {0};
		this.waveset.shouldSub = {true};
	}


	biteSul{
		this.currFunc = "biteSul";
		this.biter.value(12, 7);
	}
	...
	crankThatSoulja{
		...
		this.waveset.shouldHarmonize = false;
		this.waveset.deleteAmount = this.waveset.currSet.xings.size;
	}
	...
	speedRandomDirect{arg waitAmount = 0.5, speedStart, minSpeed, maxSpeed, direction = 0;
		Routine({
			...
			case
				...
				this.waveset.baseSpeed = {this.waveset.baseSpeed.value()*speedMultiple};
				i = i + 1;
				waitAmount.wait;
			});
			this.waveset.baseSpeed = {origSpeed};
	...
	multiplierRandomDirect{arg waitAmount = 0.5, multiplierStart, minMultiplier, maxMultiplier, direction = 0;
		Routine({
			...
			while({this.contMultiplierDirectBreak},{
				...
				this.waveset.multiplier = {this.waveset.multiplier*multiplierMultiple};
				i = i + 1;
				waitAmount.wait;
			});
			this.waveset.multiplier = {origMultiplier};
	...
	multiplierRandom{arg waitAmount = 0.5, multiplierStart, minMultiplier, maxMultiplier;
		Routine({
			...
			while({this.contMultiplierRandomBreak},{
				...
				this.waveset.multiplier = {this.waveset.multiplier.value()*multiplierMultiple};
				i = i + 1;
				waitAmount.wait;
			});
			this.waveset.multiplier = {origMultiplier};
	...
	returnCurrSet{
		this.waveset.currSet = this.holderCurrSet;
	}
	...
	takeSnapshot{
		...
		this.snapShot.waveSetAmount = this.waveset.waveSetAmount;
		this.snapShot.repeats = this.waveset.repeats;
		this.snapShot.baseSpeed = this.waveset.baseSpeed;
		...
		this.snapShot.multiplier = this.waveset.multiplier;
		this.snapShot.shouldAverage = this.waveset.shouldAverage;
		...
		this.snapShot.contBreak = this.contBreak;
